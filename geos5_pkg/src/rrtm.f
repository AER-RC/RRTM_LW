...
C      DATA WAVENUM1(9) /1180./, WAVENUM2(9) /1330./, DELWAVE(9) /150./
C      DATA WAVENUM1(10) /1330./, WAVENUM2(10) /1390./, DELWAVE(10) /60./
C      DATA WAVENUM1(11) /1390./,WAVENUM2(11) /1480./,DELWAVE(11) /90./
C      DATA WAVENUM1(12) /1480./,WAVENUM2(12) /1800./,DELWAVE(12) /320./
C      DATA WAVENUM1(13) /1800./,WAVENUM2(13) /2080./,DELWAVE(13) /280./
C      DATA WAVENUM1(14) /2080./,WAVENUM2(14) /2250./,DELWAVE(14) /170./
C      DATA WAVENUM1(15) /2250./,WAVENUM2(15) /2380./,DELWAVE(15) /130./
C      DATA WAVENUM1(16) /2380./,WAVENUM2(16) /2600./,DELWAVE(16) /220./
C      DATA WAVENUM1(17) /2600./,WAVENUM2(17) /3250./,DELWAVE(17) /650./
...
C
 ...
 3000    CONTINUE
         ...
         IF (IOUT .LE. 40 .OR. IFLAG .EQ. 17) GO TO 3500
         IF (IFLAG .EQ. 99) THEN
            IFLAG = 1
...
C     Read in surface information.
      READ (IRD,9012) TBOUND,IEMISS,IREFLECT,(SEMIS(I),I=1,17)
...
C     Test for mixing ratio input.
 ...
 9012 FORMAT (E10.3,1X,I1,2X,I1,17E5.3)
...
C        Left-justify all inputed names.                                      
   ...
   40 CONTINUE
     ...
     *     HNAMLPK / '         LINPAK.f:' /
      ...
      DATA WAVENUM1(9) /1180./, WAVENUM2(9) /1330./, DELWAVE(9) /150./
      DATA WAVENUM1(10) /1330./,WAVENUM2(10) /1390./, DELWAVE(10) /60./
      DATA WAVENUM1(11) /1390./,WAVENUM2(11) /1480./,DELWAVE(11) /90./
      DATA WAVENUM1(12) /1480./,WAVENUM2(12) /1800./,DELWAVE(12) /320./
      DATA WAVENUM1(13) /1800./,WAVENUM2(13) /2080./,DELWAVE(13) /280./
      DATA WAVENUM1(14) /2080./,WAVENUM2(14) /2250./,DELWAVE(14) /170./
      DATA WAVENUM1(15) /2250./,WAVENUM2(15) /2380./,DELWAVE(15) /130./
      DATA WAVENUM1(16) /2380./,WAVENUM2(16) /2600./,DELWAVE(16) /220./
      DATA WAVENUM1(17) /2600./,WAVENUM2(17) /3250./,DELWAVE(17) /650./

      DATA NG /16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16/
      DATA NSPA /1,1,9,9,9,1,9,1,9,9,1,1,9,9,1,9,9/
      DATA NSPB /1,1,5,5,5,0,1,1,1,5,1,1,0,0,1,0,0/
