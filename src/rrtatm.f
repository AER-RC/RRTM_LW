...
C                                                                        FA00490
      PARAMETER (MXFSC=200, MXLAY=MXFSC+3,MXZMD=3400,                    FA00500
...
C                                                                        FA00870
     ...
     *                IMDIM,IBMAX,IBDIM,IOUTMX,IOUTDM,IPMAX,IPHMID,      FA00920
     *                IPDIM,KDIM,KMXNOM,KMAX                             FA00930
...
C**********************************************************************  FA03310
C                                                                        FA03320
      PARAMETER (MXFSC=200, MXLAY=MXFSC+3,MXZMD=3400,                    FA03330
     *           MXPDIM=MXLAY+MXZMD,IM2=MXPDIM-2,MXMOL=35,MXTRAC=22)     FA03340
...
C                                                                        FA03360
     ...
     *                IPDIM,KDIM,KMXNOM,NMOL                             FA03500
...
C                                                                        FA07240
         ...
         ENDIF                                                           FA07280
C                                                                        FA07290
         IF (IBMAX.LT.1) GO TO 150                                       FA07300
...
C                                                                        FA11820
     ...
     *                IMDIM,IBMAX,IBDIM,IOUTMX,IOUTDM,IPMAX,IPHMID,      FA11840
     *                IPDIM,KDIM,KMXNOM,NMOL                             FA11850
...
C     *****************************************************************  FA12570
C                                                                        FA12580
      PARAMETER (MXFSC=200, MXLAY=MXFSC+3,MXZMD=3400,                    FA12590
     *           MXPDIM=MXLAY+MXZMD,IM2=MXPDIM-2,MXMOL=35,MXTRAC=22)     FA12600
...
C                                                                        FA13730
     ...
     *           2.549E+01, 1.743E+01, 1.197E+01, 8.010E+00, 5.746E+00,  FA13790
     *           4.150E+00, 2.871E+00, 2.060E+00, 1.491E+00, 1.090E+00,  FA13800
...
C     *****************************************************************  FA23580
C                                                                        FA23590
      PARAMETER (MXFSC=200, MXLAY=MXFSC+3,MXZMD=3400,                    FA23600
     *           MXPDIM=MXLAY+MXZMD,IM2=MXPDIM-2,MXMOL=35,MXTRAC=22)     FA23610
C                                                                        FA23620
...
C                                                                        FA24180
      ...
      GO TO 50                                                           FA24200
C                                                                        FA24210
   40 CALL NSMDL (ITYPE,MDL,CO2RAT)                                      FA24220
C                                                                        FA24230
...
C     *****************************************************************  FA24670
C                                                                        FA24680
      PARAMETER (MXFSC=200, MXLAY=MXFSC+3,MXZMD=3400,                    FA24690
     *           MXPDIM=MXLAY+MXZMD,IM2=MXPDIM-2,MXMOL=35,MXTRAC=22)     FA24700
C                                                                        FA24710
     ...
     *                IMDIM,IBMAX,IBDIM,IOUTMX,IOUTDM,IPMAX,IPHMID,      FA24760
     *                IPDIM,KDIM,KMXNOM,NMOL                             FA24770
...
C                                                                        FA25030
      ...
      READ (IRD,905) IMMAX,HMOD                                          FA25050
C                                                                        FA25060
      IMLOW = IMMAX                                                      FA25070
      WRITE (IPR,910) IMMAX,HMOD                                         FA25080
...
C                                                                        FA25350
  ...
  905 FORMAT (I5,3A8)                                                    FA25370
  910 FORMAT (//,10X,'IMMAX    = ',I5,/,10X,'PROFILE = ',3A8)            FA25380
...
C                                                                        FA26570
C                                                                        FA26580
      PARAMETER (MXFSC=200, MXLAY=MXFSC+3,MXZMD=3400,                    FA26590
     *           MXPDIM=MXLAY+MXZMD,IM2=MXPDIM-2,MXMOL=35,MXTRAC=22)     FA26600
C                                                                        FA26610
...
C     *****************************************************************  FA28520
C                                                                        FA28530
      PARAMETER (MXFSC=200, MXLAY=MXFSC+3,MXZMD=3400,                    FA28540
     *           MXPDIM=MXLAY+MXZMD,IM2=MXPDIM-2,MXMOL=35,MXTRAC=22)     FA28550
C                                                                        FA28560
...
C                                                                        FA29890
  ...
  100    WMOL(K) = VAL(A1,A2,A3,A4,X1,X2,X3,X4)                          FA29940
         IF (K.EQ.2) WMOL(2) = WMOL(2)*CO2RAT                            FA29950
         JUNIT(K) = 10                                                   FA29960
...
C***************************************************************         FA30240
C                                                                        FA30250
      PARAMETER (MXFSC=200, MXLAY=MXFSC+3,MXZMD=3400,                    FA30260
     *           MXPDIM=MXLAY+MXZMD,IM2=MXPDIM-2,MXMOL=35,MXTRAC=22)     FA30270
C                                                                        FA30280
...
C**********************************************************************  FA31220
C                                                                        FA31230
      PARAMETER (MXFSC=200, MXLAY=MXFSC+3,MXZMD=3400,                    FA31240
     *           MXPDIM=MXLAY+MXZMD,IM2=MXPDIM-2,MXMOL=35,MXTRAC=22)     FA31250
C                                                                        FA31260
...
C                                                                        FA32330
     ...
     *                IMDIM,IBMAX,IBDIM,IOUTMX,IOUTDM,IPMAX,IPHMID,      FA32380
...
C                                                                        FA34430
     ...
     *                IMDIM,IBMAX,IBDIM,IOUTMX,IOUTDM,IPMAX,IPHMID,      FA34480
     *                IPDIM,KDIM,KMXNOM,NMOL                             FA34490
C                                                                        FA34500
...
C                                                                        FA34880
     ...
     *                IMDIM,IBMAX,IBDIM,IOUTMX,IOUTDM,IPMAX,IPHMID,      FA34930
     *                IPDIM,KDIM,KMXNOM,NMOL                             FA34940
...
C     *****************************************************************  FA37790
C                                                                        FA37800
      PARAMETER (MXFSC=200, MXLAY=MXFSC+3,MXZMD=3400,                    FA37810
     *           MXPDIM=MXLAY+MXZMD,IM2=MXPDIM-2,MXMOL=35,MXTRAC=22)     FA37820
C                                                                        FA37830
     ...
     *                IMDIM,IBMAX,IBDIM,IOUTMX,IOUTDM,IPMAX,IPHMID,      FA37880
     *                IPDIM,KDIM,KMXNOM,NMOL                             FA37890
...
C     *****************************************************************  FA38900
C                                                                        FA38910
      PARAMETER (MXFSC=200, MXLAY=MXFSC+3,MXZMD=3400,                    FA38920
     *           MXPDIM=MXLAY+MXZMD,IM2=MXPDIM-2,MXMOL=35,MXTRAC=22)     FA38930
C                                                                        FA38940
     ...
     *                IMDIM,IBMAX,IBDIM,IOUTMX,IOUTDM,IPMAX,IPHMID,      FA38990
     *                IPDIM,KDIM,KMXNOM,NMOL                             FA39000
...
C     *****************************************************************  FA40550
C                                                                        FA40560
      PARAMETER (MXFSC=200, MXLAY=MXFSC+3,MXZMD=3400,                    FA40570
     *           MXPDIM=MXLAY+MXZMD,IM2=MXPDIM-2,MXMOL=35,MXTRAC=22)     FA40580
C                                                                        FA40590
     ...
     *                IMDIM,IBMAX,IBDIM,IOUTMX,IOUTDM,IPMAX,IPHMID,      FA40640
     *                IPDIM,KDIM,KMXNOM,NMOL                             FA40650
...
C     *****************************************************************  FA42360
C                                                                        FA42370
      PARAMETER (MXFSC=200, MXLAY=MXFSC+3,MXZMD=3400,                    FA42380
     *           MXPDIM=MXLAY+MXZMD,IM2=MXPDIM-2,MXMOL=35,MXTRAC=22)     FA42390
C                                                                        FA42400
     ...
     *                IMDIM,IBMAX,IBDIM,IOUTMX,IOUTDM,IPMAX,IPHMID,      FA42450
     *                IPDIM,KDIM,KMXNOM,NMOL                             FA42460
...
C     *****************************************************************  FA44590
C                                                                        FA44600
      PARAMETER (MXFSC=200, MXLAY=MXFSC+3,MXZMD=3400,                    FA44610
     *           MXPDIM=MXLAY+MXZMD,IM2=MXPDIM-2,MXMOL=35,MXTRAC=22)     FA44620
C                                                                        FA44630
     ...
     *                IMDIM,IBMAX,IBDIM,IOUTMX,IOUTDM,IPMAX,IPHMID,      FA44680
     *                IPDIM,KDIM,KMXNOM,NMOL                             FA44690
...
C     *****************************************************************  FA46430
C                                                                        FA46440
      PARAMETER (MXFSC=200, MXLAY=MXFSC+3,MXZMD=3400,                    FA46450
     *           MXPDIM=MXLAY+MXZMD,IM2=MXPDIM-2,MXMOL=35,MXTRAC=22)     FA46460
C                                                                        FA46470
     ...
     *                IMDIM,IBMAX,IBDIM,IOUTMX,IOUTDM,IPMAX,IPHMID,      FA46520
     *                IPDIM,KDIM,KMXNOM,NMOL                             FA46530
...
C                                                                        FA47020
     ...
     *                IMDIM,IBMAX,IBDIM,IOUTMX,IOUTDM,IPMAX,IPHMID,      FA47070
     *                IPDIM,KDIM,KMXNOM,NMOL                             FA47080
...
C                                                                        FX00360
     ...
     *                IMDIM,IBMAX,IBDIM,IOUTMX,IOUTDM,IPMAX,IPHMID,      FX00440
...
C     L'TH LAYER, ANALOGOUS TO AMOUNT IN /SPECIES/ FOR THE STANDARD
C     MOLECULES.                                                         FX00800
C                                                                        FX00810
...
C     *****************************************************************  FX03530
C                                                                        FX03540
      PARAMETER (MXFSC=200, MXLAY=MXFSC+3,MXZMD=3400,                    FX03550
     *           MXPDIM=MXLAY+MXZMD,IM2=MXPDIM-2,MXMOL=35,MXTRAC=22)     FX03560
C                                                                        FX03570
...
C                                                                        FX03760
     ...
     *                IMDIM,IBMAX,IBDIM,IOUTMX,IOUTDM,IPMAX,IPHMID,      FX03790
     *                IPDIM,KDIM,KMXNOM,NMOL                             FX03800
C                                                                        FX03810
...
C                                                                        FX04030
      COMMON /MLATMX/ LAYXMX,ALTX(MXZMD),AMOLX(MXZMD,MXMOL)              FX04040
                                                                         FX04050
      DIMENSION ZX(MXZMD),DTMP(MXMOL),DENX(MXMOL,MXZMD)                  FX04060
      CHARACTER JCHAR(MXMOL)*1,XTITLE*50                                 FX04070
C                                                                        FX04080
...
C                                                                        FX04520
         DO 50 L = 1, LAYX                                               FX04530
            READ (IRD,925) ZORP,(JCHAR(I),I=1,IXMOLS)                    FX04540
            WRITE (IPR,930) ZORP,(JCHAR(I),I=1,IXMOLS)                   FX04550
C                                                                        FX04560
C             IF ZORP IS PRESSURE, INTERPOLATE LOG(PRESSURE) AGAINST     FX04570
C             LOG(PM) TO GET ALTITUDE IN KM.                             FX04580
C                                                                        FX04590
            IF (IZORP.EQ.1) THEN                                         FX04600
               CALL ZINTRP (ZORP,ZMDL,PM,IMMAX,Z)                        FX04610
               ZX(L) = Z                                                 FX04620
            ELSE                                                         FX04630
               ZX(L) = ZORP                                              FX04640
            ENDIF                                                        FX04650
C                                                                        FX04660
            READ (IRD,935) (DTMP(K),K=1,IXMOLS)                          FX04670
            WRITE (IPR,940) (DTMP(K),K=1,IXMOLS)                         FX04680
C                                                                        FX04690
...
C                                                                        FX04880
  ...
  920 FORMAT (/,'      Z OR P     JCHAR',/,'  ',                         FX04960
     *        8('    DENX(',I2,')'))                                     FX04970
  925 FORMAT (F10.3,5X,35A1)                                             FX04980
  930 FORMAT (2X,F10.3,5X,35A)                                           FX04990
...
C     INTERPOLATES THE MIXING RATIO DTMP(K) AT THE ALTITUDE Z FROM THE   FX05080
C     STANDARD PROFILE IN AMOLX ON THE ALTITUDE GRID ALTX.               FX05090
C     *****************************************************************  FX05100
C                                                                        FX05110
      PARAMETER (MXFSC=200, MXLAY=MXFSC+3,MXZMD=3400,                    FX05120
     *           MXPDIM=MXLAY+MXZMD,IM2=MXPDIM-2,MXMOL=35,MXTRAC=22)     FX05130
C                                                                        FX05140
...
C     *****************************************************************  FX05670
C                                                                        FX05680
      PARAMETER (MXFSC=200, MXLAY=MXFSC+3,MXZMD=3400,                    FX05690
     *           MXPDIM=MXLAY+MXZMD,IM2=MXPDIM-2,MXMOL=35,MXTRAC=22)     FX05700
C                                                                        FX05710
...
C                                                                        FX06380
C**********************************************************************  FX06390
C     THIS SUBROUTINE FINDS THE ALTITUDE Z CORRESPONDING TO THE          FX06400
C     PRESSURE P FROM THE PROFILE DEFINED BY ZMDL AND PM.  LOGARITHMIC   FX06410
C     INTERPOLATION IS USED.                                             FX06420
C**********************************************************************  FX06430
C                                                                        FX06440
      DIMENSION ZMDL(IMMAX),PM(IMMAX)                                    FX06450
C                                                                        FX06460
      DO 10 L = 2, IMMAX                                                 FX06470
         IF (Z.LE.ZMDL(L)) GO TO 20                                      FX06480
   10 CONTINUE                                                           FX06490
      L = IMMAX                                                          FX06500
   20 CONTINUE                                                           FX06510
C                                                                        FX06520
      H = -(ZMDL(L)-ZMDL(L-1))/LOG10(PM(L)/PM(L-1))                      FX06530
      Z = ZMDL(L-1)-H*LOG10(P/PM(L-1))                                   FX06540
C                                                                        FX06550
      RETURN                                                             FX06560
C                                                                        FX06570
      END                                                                FX06580
...
C                                                                        FX06770
      PARAMETER (MXFSC=200, MXLAY=MXFSC+3,MXZMD=3400,                    FX06780
     *           MXPDIM=MXLAY+MXZMD,IM2=MXPDIM-2,MXMOL=35,MXTRAC=22)     FX06790
