...
c      DATA FRACREFA /
c     &2.1227E-01,1.8897E-01,1.3934E-01,1.1557E-01,9.5282E-02,8.3359E-02,
c     &6.5333E-02,5.2016E-02,3.4272E-02,4.0257E-03,3.1857E-03,2.6014E-03,
c     &1.9141E-03,1.2612E-03,5.3169E-04,7.6476E-05/
...
c      DATA FRACREFA /
c     & 1.6388E-01, 1.5241E-01, 1.4290E-01, 1.2864E-01, 
c     & 1.1615E-01, 1.0047E-01, 8.0013E-02, 6.0445E-02, 
c     & 4.0530E-02, 4.3879E-03, 3.5726E-03, 2.7669E-03,
c     & 2.0078E-03, 1.2864E-03, 4.7630E-04, 6.9109E-05/

C Planck fraction mapping level: P = 3.206e-2 mb, T = 197.92 K
c      DATA FRACREFB /
c     & 1.4697E-01, 1.4826E-01, 1.4278E-01, 1.3320E-01, 
c     & 1.1965E-01, 1.0297E-01, 8.4170E-02, 6.3282E-02, 
c     & 4.2868E-02, 4.6644E-03, 3.8619E-03, 3.0533E-03,
c     & 2.2359E-03, 1.4226E-03, 5.3642E-04, 7.6316E-05/
...
C Planck fraction mapping level: P=212.7250 mbar, T = 223.06 K
c     DATA (FRACREFA(IG, 1),IG=1,16) /
c    &1.6251E-01,1.5572E-01,1.4557E-01,1.3208E-01,1.1582E-01,9.6895E-02,
c    &7.8720E-02,5.8462E-02,3.9631E-02,4.3001E-03,3.5555E-03,2.8101E-03,
c    &2.0547E-03,1.3109E-03,4.9403E-04,6.9515E-05/
c     DATA (FRACREFA(IG, 2),IG=1,16) /
c    &1.6006E-01,1.5576E-01,1.4609E-01,1.3276E-01,1.1594E-01,9.7336E-02,
c    &7.9035E-02,5.8696E-02,3.9723E-02,4.3001E-03,3.5555E-03,2.8101E-03,
c    &2.0547E-03,1.3109E-03,4.9403E-04,6.9515E-05/
c     DATA (FRACREFA(IG, 3),IG=1,16) /
c    &1.5952E-01,1.5566E-01,1.4590E-01,1.3294E-01,1.1599E-01,9.7511E-02,
c    &7.9127E-02,5.8888E-02,3.9874E-02,4.3001E-03,3.5555E-03,2.8102E-03,
c    &2.0547E-03,1.3109E-03,4.9403E-04,6.9515E-05/
c     DATA (FRACREFA(IG, 4),IG=1,16) /
c    &1.5907E-01,1.5541E-01,1.4585E-01,1.3316E-01,1.1596E-01,9.7647E-02,
c    &7.9243E-02,5.9024E-02,4.0028E-02,4.3112E-03,3.5555E-03,2.8102E-03,
c    &2.0547E-03,1.3109E-03,4.9403E-04,6.9515E-05/
c     DATA (FRACREFA(IG, 5),IG=1,16) /
c    &1.5862E-01,1.5517E-01,1.4588E-01,1.3328E-01,1.1585E-01,9.7840E-02,
c    &7.9364E-02,5.9174E-02,4.0160E-02,4.3403E-03,3.5900E-03,2.8102E-03,
c    &2.0547E-03,1.3109E-03,4.9403E-04,6.9515E-05/
c     DATA (FRACREFA(IG, 6),IG=1,16) /
c    &1.5830E-01,1.5490E-01,1.4582E-01,1.3331E-01,1.1567E-01,9.8079E-02,
c    &7.9510E-02,5.9369E-02,4.0326E-02,4.3343E-03,3.5908E-03,2.8527E-03,
c    &2.0655E-03,1.3109E-03,4.9403E-04,6.9515E-05/
c     DATA (FRACREFA(IG, 7),IG=1,16) /
c    &1.5789E-01,1.5435E-01,1.4595E-01,1.3304E-01,1.1566E-01,9.8426E-02,
c    &7.9704E-02,5.9618E-02,4.0520E-02,4.3812E-03,3.6147E-03,2.8395E-03,
c    &2.1301E-03,1.3145E-03,4.9403E-04,6.9515E-05/
c     DATA (FRACREFA(IG, 8),IG=1,16) /
c    &1.5704E-01,1.5398E-01,1.4564E-01,1.3222E-01,1.1586E-01,9.9230E-02,
c    &8.0011E-02,6.0149E-02,4.0790E-02,4.4253E-03,3.6534E-03,2.9191E-03,
c    &2.1373E-03,1.3558E-03,5.1631E-04,7.8794E-05/
c     DATA (FRACREFA(IG, 9),IG=1,16) /
c    &1.5270E-01,1.5126E-01,1.4264E-01,1.3106E-01,1.1740E-01,1.0137E-01,
c    &8.3057E-02,6.2282E-02,4.2301E-02,4.6486E-03,3.8159E-03,3.0472E-03,
c    &2.2870E-03,1.4818E-03,5.6773E-04,7.8794E-05/
C Planck fraction mapping level: P = 95.8 mbar, T = 215.7 K
c     DATA (FRACREFB(IG, 1),IG=1,16) /
c    &1.6413E-01,1.5665E-01,1.4606E-01,1.3184E-01,1.1517E-01,9.6243E-02,
c    &7.7982E-02,5.8165E-02,3.9311E-02,4.2586E-03,3.5189E-03,2.7793E-03,
c    &2.0376E-03,1.2938E-03,4.8853E-04,6.8745E-05/
c     DATA (FRACREFB(IG, 2),IG=1,16) /
c    &1.6254E-01,1.5674E-01,1.4652E-01,1.3221E-01,1.1535E-01,9.6439E-02,
c    &7.8155E-02,5.8254E-02,3.9343E-02,4.2586E-03,3.5189E-03,2.7793E-03,
c    &2.0376E-03,1.2938E-03,4.8853E-04,6.8745E-05/
c     DATA (FRACREFB(IG, 3),IG=1,16) /
c    &1.6177E-01,1.5664E-01,1.4669E-01,1.3242E-01,1.1541E-01,9.6536E-02,
c    &7.8257E-02,5.8387E-02,3.9431E-02,4.2587E-03,3.5189E-03,2.7793E-03,
c    &2.0376E-03,1.2938E-03,4.8853E-04,6.8745E-05/
c     DATA (FRACREFB(IG, 4),IG=1,16) /
c    &1.6077E-01,1.5679E-01,1.4648E-01,1.3273E-01,1.1546E-01,9.6779E-02,
c    &7.8371E-02,5.8546E-02,3.9611E-02,4.2772E-03,3.5190E-03,2.7793E-03,
c    &2.0376E-03,1.2938E-03,4.8853E-04,6.8745E-05/
c     DATA (FRACREFB(IG, 5),IG=1,16) /
c    &1.6067E-01,1.5608E-01,1.4247E-01,1.2881E-01,1.1449E-01,9.8802E-02,
c    &8.0828E-02,6.0977E-02,4.1494E-02,4.5116E-03,3.7290E-03,2.9460E-03,
c    &2.1948E-03,1.3778E-03,5.4552E-04,7.9969E-05/
...
c      DATA (FRACREFA(IG, 1),IG=1,16) /
c     &1.5572E-01,1.4925E-01,1.4107E-01,1.3126E-01,1.1791E-01,1.0173E-01,
c     &8.2949E-02,6.2393E-02,4.2146E-02,4.5907E-03,3.7965E-03,2.9744E-03,
c     &2.2074E-03,1.4063E-03,5.3012E-04,7.4595E-05/
c      DATA (FRACREFA(IG, 2),IG=1,16) /
c     &1.5572E-01,1.4925E-01,1.4107E-01,1.3126E-01,1.1791E-01,1.0173E-01,
c     &8.2949E-02,6.2392E-02,4.2146E-02,4.5906E-03,3.7965E-03,2.9745E-03,
c     &2.2074E-03,1.4063E-03,5.3012E-04,7.4595E-05/
c      DATA (FRACREFA(IG, 3),IG=1,16) /
c     &1.5572E-01,1.4925E-01,1.4107E-01,1.3126E-01,1.1791E-01,1.0173E-01,
c     &8.2949E-02,6.2393E-02,4.2146E-02,4.5907E-03,3.7965E-03,2.9745E-03,
c     &2.2074E-03,1.4063E-03,5.3012E-04,7.4595E-05/
c      DATA (FRACREFA(IG, 4),IG=1,16) /
c     &1.5572E-01,1.4925E-01,1.4107E-01,1.3126E-01,1.1791E-01,1.0173E-01,
c     &8.2949E-02,6.2393E-02,4.2146E-02,4.5907E-03,3.7964E-03,2.9744E-03,
c     &2.2074E-03,1.4063E-03,5.3012E-04,7.4595E-05/
c      DATA (FRACREFA(IG, 5),IG=1,16) /
c     &1.5572E-01,1.4925E-01,1.4107E-01,1.3126E-01,1.1791E-01,1.0173E-01,
c     &8.2949E-02,6.2393E-02,4.2146E-02,4.5907E-03,3.7965E-03,2.9744E-03,
...
c     &2.2074E-03,1.4063E-03,5.3012E-04,7.4595E-05/
c      DATA (FRACREFA(IG, 7),IG=1,16) /
c     &1.5572E-01,1.4926E-01,1.4107E-01,1.3126E-01,1.1791E-01,1.0173E-01,
c     &8.2949E-02,6.2393E-02,4.2146E-02,4.5908E-03,3.7964E-03,2.9745E-03,
c     &2.2074E-03,1.4063E-03,5.3012E-04,7.4595E-05/
c      DATA (FRACREFA(IG, 8),IG=1,16) /
c     &1.5571E-01,1.4926E-01,1.4107E-01,1.3125E-01,1.1791E-01,1.0173E-01,
c     &8.2949E-02,6.2393E-02,4.2146E-02,4.5907E-03,3.7964E-03,2.9744E-03,
c     &2.2074E-03,1.4063E-03,5.3012E-04,7.4595E-05/
c      DATA (FRACREFA(IG, 9),IG=1,16) /
c     &1.5952E-01,1.5155E-01,1.4217E-01,1.3077E-01,1.1667E-01,1.0048E-01,
c     &8.1511E-02,6.1076E-02,4.1111E-02,4.4432E-03,3.6910E-03,2.9076E-03,
c     &2.1329E-03,1.3566E-03,5.2235E-04,7.9935E-05/
c
cC Planck fraction mapping level : P = 95.58350 mb, T = 215.70 K
c
c      DATA (FRACREFB(IG, 1),IG=1,16) /
c     &1.5558E-01,1.4931E-01,1.4104E-01,1.3124E-01,1.1793E-01,1.0160E-01,
c     &8.3142E-02,6.2403E-02,4.2170E-02,4.5935E-03,3.7976E-03,2.9986E-03,
c     &2.1890E-03,1.4061E-03,5.3005E-04,7.4587E-05/
c      DATA (FRACREFB(IG, 2),IG=1,16) /
c     &1.5558E-01,1.4932E-01,1.4104E-01,1.3124E-01,1.1792E-01,1.0159E-01,
c     &8.3142E-02,6.2403E-02,4.2170E-02,4.5935E-03,3.7976E-03,2.9986E-03,
c     &2.1890E-03,1.4061E-03,5.3005E-04,7.4587E-05/
c      DATA (FRACREFB(IG, 3),IG=1,16) /
c     &1.5558E-01,1.4933E-01,1.4103E-01,1.3124E-01,1.1792E-01,1.0159E-01,
c     &8.3142E-02,6.2403E-02,4.2170E-02,4.5935E-03,3.7976E-03,2.9986E-03,
c     &2.1890E-03,1.4061E-03,5.3005E-04,7.4587E-05/
c      DATA (FRACREFB(IG, 4),IG=1,16) /
c     &1.5569E-01,1.4926E-01,1.4102E-01,1.3122E-01,1.1791E-01,1.0159E-01,
c     &8.3141E-02,6.2403E-02,4.2170E-02,4.5935E-03,3.7976E-03,2.9986E-03,
c     &2.1890E-03,1.4061E-03,5.3005E-04,7.4587E-05/
c      DATA (FRACREFB(IG, 5),IG=1,16) /
c     &1.5947E-01,1.5132E-01,1.4195E-01,1.3061E-01,1.1680E-01,1.0054E-01,
c     &8.1785E-02,6.1212E-02,4.1276E-02,4.4424E-03,3.6628E-03,2.8943E-03,
c     &2.1134E-03,1.3457E-03,5.1024E-04,7.3998E-05/
c
      EQUIVALENCE (KA,ABSA),(KB,ABSB)
      REAL KA,KB
      EQUIVALENCE (PA,PLAA),(PB,PLAB)
...
C  Input
     ...
     &                  RAT_O3CO2(MXLAY),RAT_O3CO2_1(MXLAY)
      ...
      COMMON /MINOR/    MINORFRAC(MXLAY), INDMINOR(MXLAY), 
     &                  SCALEMINOR(MXLAY),SCALEMINORN2(MXLAY)
      COMMON /K5/       KA(9,11,13,MG), KB(5,5,13:59,MG),
     &                  FORREF(4,MG),SELFREF(10,MG), KA_MO3(9,19,MG),
     &                  PA(9,11,13,MG), PB(5,5,13:59,MG)

      COMMON /CVRTAU/    HNAMTAU,HVRTAU

      CHARACTER*18       HNAMTAU,HVRTAU

      DIMENSION ABSB(1175,MG)
      DIMENSION PLAB(1175,MG)			
      DIMENSION CCL4(MG)
...
c      DATA (FRACREFA(IG, 1),IG=1,16) /
c     &1.4111E-01,1.4222E-01,1.3802E-01,1.3101E-01,1.2244E-01,1.0691E-01,
c     &8.8703E-02,6.7130E-02,4.5509E-02,4.9866E-03,4.1214E-03,3.2557E-03,
c     &2.3805E-03,1.5450E-03,5.8423E-04,8.2275E-05/
c      DATA (FRACREFA(IG, 2),IG=1,16) /
c     &1.4152E-01,1.4271E-01,1.3784E-01,1.3075E-01,1.2215E-01,1.0674E-01,
c     &8.8686E-02,6.7135E-02,4.5508E-02,4.9866E-03,4.1214E-03,3.2558E-03,
c     &2.3805E-03,1.5450E-03,5.8423E-04,8.2275E-05/
c      DATA (FRACREFA(IG, 3),IG=1,16) /
c     &1.4159E-01,1.4300E-01,1.3781E-01,1.3094E-01,1.2192E-01,1.0661E-01,
c     &8.8529E-02,6.7127E-02,4.5511E-02,4.9877E-03,4.1214E-03,3.2558E-03,
c     &2.3805E-03,1.5450E-03,5.8423E-04,8.2275E-05/
c      DATA (FRACREFA(IG, 4),IG=1,16) /
c     &1.4162E-01,1.4337E-01,1.3774E-01,1.3122E-01,1.2172E-01,1.0641E-01,
c     &8.8384E-02,6.7056E-02,4.5514E-02,4.9880E-03,4.1214E-03,3.2557E-03,
c     &2.3805E-03,1.5450E-03,5.8423E-04,8.2275E-05/
c      DATA (FRACREFA(IG, 5),IG=1,16) /
c     &1.4161E-01,1.4370E-01,1.3770E-01,1.3143E-01,1.2173E-01,1.0613E-01,
c     &8.8357E-02,6.6874E-02,4.5509E-02,4.9883E-03,4.1214E-03,3.2558E-03,
c     &2.3804E-03,1.5450E-03,5.8423E-04,8.2275E-05/
c      DATA (FRACREFA(IG, 6),IG=1,16) /
c     &1.4154E-01,1.4405E-01,1.3771E-01,1.3169E-01,1.2166E-01,1.0603E-01,
c     &8.8193E-02,6.6705E-02,4.5469E-02,4.9902E-03,4.1214E-03,3.2558E-03,
c     &2.3804E-03,1.5450E-03,5.8423E-04,8.2275E-05/
c      DATA (FRACREFA(IG, 7),IG=1,16) /
c     &1.4126E-01,1.4440E-01,1.3790E-01,1.3214E-01,1.2153E-01,1.0603E-01,
c     &8.7908E-02,6.6612E-02,4.5269E-02,4.9900E-03,4.1256E-03,3.2558E-03,
c     &2.3804E-03,1.5451E-03,5.8423E-04,8.2275E-05/
c      DATA (FRACREFA(IG, 8),IG=1,16) /
c     &1.4076E-01,1.4415E-01,1.3885E-01,1.3286E-01,1.2147E-01,1.0612E-01,
c     &8.7579E-02,6.6280E-02,4.4977E-02,4.9782E-03,4.1200E-03,3.2620E-03,
c     &2.3820E-03,1.5452E-03,5.8423E-04,8.2275E-05/
c      DATA (FRACREFA(IG, 9),IG=1,16) /
c     &1.4205E-01,1.4496E-01,1.4337E-01,1.3504E-01,1.2260E-01,1.0428E-01,
c     &8.4946E-02,6.3625E-02,4.2951E-02,4.7313E-03,3.9157E-03,3.0879E-03,
c     &2.2666E-03,1.5193E-03,5.7469E-04,8.1674E-05/

C Planck fraction mapping level : P = 0.2369280 mbar, T = 253.60 K
c      DATA (FRACREFB(IG, 1),IG=1,16) /
c     &1.4075E-01,1.4196E-01,1.3833E-01,1.3345E-01,1.2234E-01,1.0718E-01,
c     &8.8004E-02,6.6308E-02,4.5028E-02,4.9029E-03,4.0377E-03,3.1870E-03,
c     &2.3503E-03,1.5146E-03,5.7165E-04,8.2371E-05/
c      DATA (FRACREFB(IG, 2),IG=1,16) /
c     &1.4081E-01,1.4225E-01,1.3890E-01,1.3410E-01,1.2254E-01,1.0680E-01,
c     &8.7391E-02,6.5819E-02,4.4725E-02,4.9121E-03,4.0420E-03,3.1869E-03,
c     &2.3504E-03,1.5146E-03,5.7165E-04,8.2371E-05/
c      DATA (FRACREFB(IG, 3),IG=1,16) /
c     &1.4087E-01,1.4227E-01,1.3920E-01,1.3395E-01,1.2270E-01,1.0694E-01,
c     &8.7229E-02,6.5653E-02,4.4554E-02,4.8797E-03,4.0460E-03,3.1939E-03,
c     &2.3505E-03,1.5146E-03,5.7165E-04,8.1910E-05/
c      DATA (FRACREFB(IG, 4),IG=1,16) /
c     &1.4089E-01,1.4238E-01,1.3956E-01,1.3379E-01,1.2284E-01,1.0688E-01,
c     &8.7192E-02,6.5490E-02,4.4390E-02,4.8395E-03,4.0173E-03,3.2070E-03,
c     &2.3559E-03,1.5146E-03,5.7165E-04,8.2371E-05/
c      DATA (FRACREFB(IG, 5),IG=1,16) /
c     &1.4091E-01,1.4417E-01,1.4194E-01,1.3457E-01,1.2167E-01,1.0551E-01,
c     &8.6450E-02,6.4889E-02,4.3584E-02,4.7551E-03,3.9509E-03,3.1374E-03,
c     &2.3226E-03,1.4942E-03,5.7545E-04,8.0887E-05/
...
C OLD         IND0 = ((JP(LAY)-1)*5+(JT(LAY)-1))*NSPA(5) + JS
C OLD         IND1 = (JP(LAY)*5+(JT1(LAY)-1))*NSPA(5) + JS1
         IND0 = ((JP(LAY)-1)*11+(JTt(LAY)-1))*NSPA(5) + JS
         IND1 = ((JP(LAY)-1)*11+ JTt(LAY))*NSPA(5) + JS1
         INDS = INDSELF(LAY)
         INDF = INDFOR(LAY)
         INDM = INDMINOR(LAY)
...
C                  ind0+1 - low P, low T, high eta - fac100
C                  ind0+9 - low P, high T, low eta - fac010
C                  ind0+10 - low P, high T, high eta - fac110
C
C                  ind1 - high P, low T*, low eta - fac001
C                  ind1+1 - high P, low T*, high eta - fac101
C                  ind1+9 - high P, high T*, low eta - fac011
C                  ind1+10 - high P, high T*, high eta - fac111
C
C         all these definitions apply to the new rrtm
C                  fac10 - low P, high T
C                  fac00 - low P, low T
C                  fac11 - high P, highT*
C                  fac01 - high P, low T*
C
C                  ind0 - low P, low T, low eta 
C                  ind0+1 - low P, low T, high eta
C                  ind0+99 - high P, low T, low eta 
C                  ind0+100 - high P, low T, high eta
C
C                  ind1 - low P, high T*, low eta 
C                  ind1+1 - low P, high T*, high eta
C                  ind1+99 - high P, high T*, low eta 
C                  ind1+100 - high P, high T*, high eta
     ...
     &               FAC100 * ABSA(IND0+1,IG) +
     &               FAC200 * ABSA(IND0+2,IG) +
     &               FAC010 * ABSA(IND0+99,IG) +
     &               FAC110 * ABSA(IND0+100,IG) +
     &               FAC210 * ABSA(IND0+101,IG))
c     &               (FAC000 * ABSA(IND0,IG) +
c     &               FAC100 * ABSA(IND0+1,IG) +
c     &               FAC200 * ABSA(IND0+2,IG) +
c     &               FAC010 * ABSA(IND0+9,IG) +
c     &               FAC110 * ABSA(IND0+10,IG) +
c     &               FAC210 * ABSA(IND0+11,IG))
           	PLANCK_MAJOR =  
     &               (FAC000 * PLAA(IND0,IG) +
     &               FAC100 * PLAA(IND0+1,IG) +
     &               FAC200 * PLAA(IND0+2,IG) +
     &               FAC010 * PLAA(IND0+99,IG) +
     &               FAC110 * PLAA(IND0+100,IG) +
     &               FAC210 * PLAA(IND0+101,IG))            
c     &               FAC000 * PLAA(IND0,IG) +
c     &               FAC100 * PLAA(IND0+1,IG) +
c     &               FAC200 * PLAA(IND0+2,IG) +
c     &               FAC010 * PLAA(IND0+9,IG) +
c     &               FAC110 * PLAA(IND0+10,IG) +
c     &               FAC210 * PLAA(IND0+11,IG)
             ELSEIF (SPECPARM .GT. 0.875) THEN
                 TAU_MAJOR =  SPECCOMB * 
     &              (FAC200 * ABSA(IND0-1,IG) +
     &               FAC100 * ABSA(IND0,IG) +
     &               FAC000 * ABSA(IND0+1,IG) +
     &               FAC210 * ABSA(IND0+98,IG) +
     &               FAC110 * ABSA(IND0+99,IG) +
     &               FAC010 * ABSA(IND0+100,IG))
c     &               (FAC200 * ABSA(IND0-1,IG) +
c     &               FAC100 * ABSA(IND0,IG) +
c     &               FAC000 * ABSA(IND0+1,IG) +
c     &               FAC210 * ABSA(IND0+8,IG) +
c     &               FAC110 * ABSA(IND0+9,IG) +
c     &               FAC010 * ABSA(IND0+10,IG))
            	     PLANCK_MAJOR =  
     &              (FAC200 * PLAA(IND0-1,IG) +
     &               FAC100 * PLAA(IND0,IG) +
     &               FAC000 * PLAA(IND0+1,IG) +
     &               FAC210 * PLAA(IND0+98,IG) +
     &               FAC110 * PLAA(IND0+99,IG) +
     &               FAC010 * PLAA(IND0+100,IG))
c     &               FAC200 * PLAA(IND0-1,IG) +
c     &               FAC100 * PLAA(IND0,IG) +
c     &               FAC000 * PLAA(IND0+1,IG) +
c     &               FAC210 * PLAA(IND0+8,IG) +
c     &               FAC110 * PLAA(IND0+9,IG) +
c     &               FAC010 * PLAA(IND0+10,IG)
             ELSE
               TAU_MAJOR = SPECCOMB * 
     &              (FAC000 * ABSA(IND0,IG) +
     &               FAC100 * ABSA(IND0+1,IG) +
     ...
     &               FAC101 * ABSA(IND1+1,IG) +
     &               FAC201 * ABSA(IND1+2,IG) +
     &               FAC011 * ABSA(IND1+99,IG) +
     &               FAC111 * ABSA(IND1+100,IG) +
     &               FAC211 * ABSA(IND1+101,IG))
c     &               (FAC001 * ABSA(IND1,IG) +
c     &               FAC101 * ABSA(IND1+1,IG) +
c     &               FAC201 * ABSA(IND1+2,IG) +
c     &               FAC011 * ABSA(IND1+9,IG) +
c     &               FAC111 * ABSA(IND1+10,IG) +
c     &               FAC211 * ABSA(IND1+11,IG))
             PLANCK_MAJOR1 = 
     &               (FAC001 * PLAA(IND1,IG) +
     &               FAC101 * PLAA(IND1+1,IG) +
     &               FAC201 * PLAA(IND1+2,IG) +
     &               FAC011 * PLAA(IND1+99,IG) +
     &               FAC111 * PLAA(IND1+100,IG) +
     &               FAC211 * PLAA(IND1+101,IG)) 
c     &               FAC001 * PLAA(IND1,IG) +
c     &               FAC101 * PLAA(IND1+1,IG) +
c     &               FAC201 * PLAA(IND1+2,IG) +
c     &               FAC011 * PLAA(IND1+9,IG) +
c     &               FAC111 * PLAA(IND1+10,IG) +
c     &               FAC211 * PLAA(IND1+11,IG)
             ELSEIF (SPECPARM1 .GT. 0.875) THEN
                 TAU_MAJOR1 =  SPECCOMB1 * 
     &               (FAC201 * ABSA(IND1-1,IG) +
     &               FAC101 * ABSA(IND1,IG) +
     &               FAC001 * ABSA(IND1+1,IG) +
     &               FAC211 * ABSA(IND1+98,IG) +
     &               FAC111 * ABSA(IND1+99,IG) +
     &               FAC011 * ABSA(IND1+100,IG))
c     &               (FAC201 * ABSA(IND1-1,IG) +
c     &               FAC101 * ABSA(IND1,IG) +
c     &               FAC001 * ABSA(IND1+1,IG) +
c     &               FAC211 * ABSA(IND1+8,IG) +
c     &               FAC111 * ABSA(IND1+9,IG) +
c     &               FAC011 * ABSA(IND1+10,IG))
		            PLANCK_MAJOR1 = 
     &               (FAC201 * PLAA(IND1-1,IG) +
     &               FAC101 * PLAA(IND1,IG) +
     &               FAC001 * PLAA(IND1+1,IG) +
     &               FAC211 * PLAA(IND1+98,IG) +
     &               FAC111 * PLAA(IND1+99,IG) +
     &               FAC011 * PLAA(IND1+100,IG))
c     &               FAC201 * PLAA(IND1-1,IG) +
c     &               FAC101 * PLAA(IND1,IG) +
c     &               FAC001 * PLAA(IND1+1,IG) +
c     &               FAC211 * PLAA(IND1+8,IG) +
c     &               FAC111 * PLAA(IND1+9,IG) +
c     &               FAC011 * PLAA(IND1+10,IG)
             ELSE
                 TAU_MAJOR1 = SPECCOMB1 * 
     &               (FAC001 * ABSA(IND1,IG) +
     &               FAC101 * ABSA(IND1+1,IG) +
...
c      DATA FRACREFA /
c     &1.4353E-01,1.4774E-01,1.4467E-01,1.3785E-01,1.2376E-01,1.0214E-01,
c     &8.1984E-02,6.1152E-02,4.0987E-02,4.5067E-03,4.0020E-03,3.1772E-03,
c     &2.3458E-03,1.5025E-03,5.7415E-04,8.2970E-05/
...
c      DATA (FRACREFA(IG, 1),IG=1,16) /
c     &1.6312E-01,1.4949E-01,1.4305E-01,1.3161E-01,1.1684E-01,9.9900E-02,
c     &8.0912E-02,6.0203E-02,4.0149E-02,4.3365E-03,3.5844E-03,2.8019E-03,
c     &2.0756E-03,1.3449E-03,5.0492E-04,7.1194E-05/
c      DATA (FRACREFA(IG, 2),IG=1,16) /
c     &1.6329E-01,1.4989E-01,1.4328E-01,1.3101E-01,1.1691E-01,9.9754E-02,
c     &8.0956E-02,5.9912E-02,4.0271E-02,4.3298E-03,3.5626E-03,2.8421E-03,
c     &2.1031E-03,1.3360E-03,4.8965E-04,6.8900E-05/
c      DATA (FRACREFA(IG, 3),IG=1,16) /
c     &1.6236E-01,1.5081E-01,1.4341E-01,1.3083E-01,1.1684E-01,9.9701E-02,
c     &8.0956E-02,5.9884E-02,4.0245E-02,4.3837E-03,3.6683E-03,2.9250E-03,
c     &2.0969E-03,1.3320E-03,4.8965E-04,6.8900E-05/
c      DATA (FRACREFA(IG, 4),IG=1,16) /
c     &1.6096E-01,1.5183E-01,1.4354E-01,1.3081E-01,1.1687E-01,9.9619E-02,
c     &8.0947E-02,5.9899E-02,4.0416E-02,4.4389E-03,3.7280E-03,2.9548E-03,
c     &2.0977E-03,1.3305E-03,4.8965E-04,6.8900E-05/
c      DATA (FRACREFA(IG, 5),IG=1,16) /
c     &1.5661E-01,1.5478E-01,1.4414E-01,1.3097E-01,1.1695E-01,9.9823E-02,
c     &8.0750E-02,6.0100E-02,4.0741E-02,4.4598E-03,3.7366E-03,2.9521E-03,
c     &2.0980E-03,1.3297E-03,4.8965E-04,6.8900E-05/
c      DATA (FRACREFA(IG, 6),IG=1,16) /
c     &1.4879E-01,1.5853E-01,1.4586E-01,1.3162E-01,1.1729E-01,1.0031E-01,
c     &8.0908E-02,6.0460E-02,4.1100E-02,4.4578E-03,3.7388E-03,2.9508E-03,
c     &2.0986E-03,1.3288E-03,4.8965E-04,6.8900E-05/
c      DATA (FRACREFA(IG, 7),IG=1,16) /
c     &1.4117E-01,1.4838E-01,1.4807E-01,1.3759E-01,1.2218E-01,1.0228E-01,
c     &8.2130E-02,6.1546E-02,4.1522E-02,4.4577E-03,3.7428E-03,2.9475E-03,
c     &2.0997E-03,1.3277E-03,4.8965E-04,6.8900E-05/
c      DATA (FRACREFA(IG, 8),IG=1,16) /
c     &1.4018E-01,1.4207E-01,1.3919E-01,1.3332E-01,1.2325E-01,1.0915E-01,
c     &9.0280E-02,6.5554E-02,4.1852E-02,4.4707E-03,3.7572E-03,2.9364E-03,
c     &2.1023E-03,1.3249E-03,4.8965E-04,6.8900E-05/
c      DATA (FRACREFA(IG, 9),IG=1,16) /
c     &1.4863E-01,1.4926E-01,1.4740E-01,1.3558E-01,1.1999E-01,1.0044E-01,
c     &8.1927E-02,6.0989E-02,4.0665E-02,4.4481E-03,3.7369E-03,2.9482E-03,
c     &2.0976E-03,1.3281E-03,4.8965E-04,6.8900E-05/
c
cc Planck fraction mapping level : P=95.58 mbar, T= 215.70 K
c      DATA FRACREFB /
c     &1.5872E-01,1.5443E-01,1.4413E-01,1.3147E-01,1.1634E-01,9.8914E-02,
c     &8.0236E-02,6.0197E-02,4.0624E-02,4.4225E-03,3.6688E-03,2.9074E-03,
c     &2.0862E-03,1.3039E-03,4.8561E-04,6.8854E-05/
